    ...
    else
    {
        switch (IrpStack->Parameters.QueryId.IdType)
        {
            ...
            case BusQueryHardwareIDs:
                ...
                //
                //TODO проверить, обновил ExAllocatePoolWithTag
        ...
        else
        {
            ...
            switch (transferPacket->reportId)
            {
                case REPORTID_CONTROL:
                    ...
                    if (pReport->ReportLength <= transferPacket->reportBufferLen - sizeof(VMultiControlReportHeader))
                    {
                        ...
                        if (NT_SUCCESS(status))
                        {
                            ...
                            VMultiPrint(DEBUG_LEVEL_INFO, DBG_IOCTL,
                                    "VMultiWriteReport %llu bytes written\n", bytesWritten);
                        }
                    }
                    else
                    {
                        ...
                        VMultiPrint(DEBUG_LEVEL_ERROR, DBG_IOCTL,
                                "VMultiWriteReport Error pReport.ReportLength (%ld) is too big for buffer size (%llu)\n", 
                                pReport->ReportLength,
                ...
                default:
                    ...
                    VMultiPrint(DEBUG_LEVEL_ERROR, DBG_IOCTL,
                            "VMultiWriteReport Unhandled report type %ld\n", transferPacket->reportId);
    ...
    )
{
    ...
    if (NT_SUCCESS(status)) 
    {
        ...
        if (NT_SUCCESS(status)) 
        {
            ...
            VMultiPrint(DEBUG_LEVEL_INFO, DBG_IOCTL,
                    "VMultiProcessVendorReport %llu bytes returned\n", bytesReturned);
            ...
            switch (transferPacket->reportId)
            {
                case REPORTID_FEATURE:
                    ...
                    else
                    {
                        ...
                        VMultiPrint(DEBUG_LEVEL_ERROR, DBG_IOCTL,
                                "VMultiSetFeature Error transferPacket->reportBufferLen (%dl) is different from sizeof(VMultiFeatureReport) (%llu)\n", 
                ...
                default:
                    ...
                    VMultiPrint(DEBUG_LEVEL_ERROR, DBG_IOCTL,
                            "VMultiSetFeature Unhandled report type %dl\n", transferPacket->reportId);
            ...
            switch (transferPacket->reportId)
            {
                case REPORTID_MTOUCH:
                {
                    ...
                    else
                    {
                        ...
                        VMultiPrint(DEBUG_LEVEL_ERROR, DBG_IOCTL,
                                "VMultiGetFeature Error transferPacket->reportBufferLen (%ld) is different from sizeof(VMultiMaxCountReport) (%llu)\n", 
                                transferPacket->reportBufferLen,
                ...
                case REPORTID_FEATURE:
                {
                    ...
                    else
                    {
                        ...
                        VMultiPrint(DEBUG_LEVEL_ERROR, DBG_IOCTL,
                                "VMultiGetFeature Error transferPacket->reportBufferLen (%ld) is different from sizeof(VMultiFeatureReport) (%llu)\n", 
                                transferPacket->reportBufferLen,
                                sizeof(VMultiFeatureReport));
                    }
